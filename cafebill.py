...
root.title("Cafe bill generator")
...
#-----------------INFO TOP------------
lblinfo = Label(Tops, font=( 'aria' ,30, 'bold' ),text="Cafe bill generator",fg="Black",bd=10,anchor='w')
...
lblTax = Label(f1, font=( 'aria' ,16, 'bold' ),text="Tax(GST)",fg="black",bd=10,anchor='w')
